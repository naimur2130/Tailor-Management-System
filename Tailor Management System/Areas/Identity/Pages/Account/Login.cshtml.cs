...
namespace Tailor_Management_System.Areas.Identity.Pages.Account
{
    [AllowAnonymous]
        ...
        public async Task<IActionResult> OnPostAsync(string returnUrl = null)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                if (result.Succeeded)
                {
                    ...
                    {
                        ModelState.AddModelError(string.Empty, "User data incomplete.");
                        return Page();
                    }
                    ...
                    if (await _userManager.IsInRoleAsync(user, "Tailor"))
                    {
